...
class SitupAnalyzer:
    ...
    def _maybe_adapt_thresholds(self, angle: float) -> None:
        ...
        self.down_thr = float(np.clip(down_thr, 95.0, 145.0))
        self.up_thr = float(np.clip(up_thr, self.down_thr + 20.0, 178.0))
    ...
    def analyze_frame(self, kp: dict) -> dict:
        ...
        self._maybe_adapt_thresholds(angle)
